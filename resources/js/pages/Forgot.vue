    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card shadow-sm">
          ...
          <div class="card-body">
            <form v-if="step === 1" @submit.prevent="submitRecovery">
              <div class="mb-3">
            ...
            <form v-if="step === 2" @submit.prevent="submitNewPassword">
              <hr />
              <div class="mb-3">
  ...
  methods: {
    ...
    async submitNewPassword() {
      ...
      try {
        ...
        const data = await res.json();
        if (res.ok) {
          this.$router.push({ path: '/auth', query: { success: 'Senha alterada com sucesso!' } });
        } else {
